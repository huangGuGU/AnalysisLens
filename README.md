...
![AnalysisLens main interface](docs/images/main-interface.heic)



![AnalysisLens main interface](docs/images/main-interface-light.heic)
...
![AnalysisLens visualized date](docs/images/visualized-date.heic)
...
![AnalysisLens lens highlight](docs/images/lens-highlight.heic)

### 异常图片具体信息查看

点击状态行的列表图标后，可以查看 skipped / failed 文件的具体路径和原因。

![AnalysisLens issue details](docs/images/issue-details.heic)
